...
client.channels.cache.get("779378065628201018").send(oskobs)//kanalid
})
...
client.on("guildMemberAdd", async member => {
    ...
    member.roles.add("779378065556897816")//Şüpheli Hesap
    
    }else{
    
    member.roles.add("779378065519411219")//Güvenilir Hesağ
